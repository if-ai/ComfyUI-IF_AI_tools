...
app.registerExtension({
    name: "Comfy.IFtoolsLoadImagesNodeS",
    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData.name !== "IF_tools_LoadImagesS") return;
        ...
        nodeType.prototype.onNodeCreated = function() {
            ...
            const backupBtn = this.addWidget("button", "backup_input", "Backup Input 💾", 
                async () => {
                    try {
                        const response = await api.fetchApi("/IF_tools/backup_input", {
                            method: "POST"
                        });
            ...
            const restoreBtn = this.addWidget("button", "restore_input", "Restore Input ♻️", 
                async () => {
                    try {
                        const response = await api.fetchApi("/IF_tools/restore_input", {
                            method: "POST"
                        });
            ...
            const refreshBtn = this.addWidget("button", "refresh_preview", "Refresh Previews 🔄", async () => {
                try {
                    ...
                    const response = await api.fetchApi("/IF_tools/refresh_previews", {
                        method: "POST",
        ...
        nodeType.prototype.backupInputFolder = async function() {
            try {
                this.showLoader();
                const response = await fetch("/IF_tools/backup_input", {
                    method: "POST"
                });
        ...
        nodeType.prototype.restoreInputFolder = async function() {
            try {
                this.showLoader();
                const response = await fetch("/IF_tools/restore_input", {
                    method: "POST"
                });
        ...
        nodeType.prototype.refreshPreviews = async function() {
            try {
                ...
                const response = await fetch("/IF_tools/refresh_previews", {
                    method: "POST",
                    headers: {
