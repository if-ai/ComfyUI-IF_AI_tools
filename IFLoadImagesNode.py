...
@PromptServer.instance.routes.post("/if_ai/backup_input")
...
@PromptServer.instance.routes.post("/if_ai/restore_input")
...
@PromptServer.instance.routes.post("/if_ai/refresh_previews")
...
@PromptServer.instance.routes.post("/if_ai/refresh_widgets")
