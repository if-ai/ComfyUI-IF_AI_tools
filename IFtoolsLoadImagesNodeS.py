...
@PromptServer.instance.routes.post("/IF_tools/backup_input")
...
@PromptServer.instance.routes.post("/IF_tools/restore_input")
...
@PromptServer.instance.routes.post("/IF_tools/refresh_previews")
...
@PromptServer.instance.routes.post("/IF_tools/refresh_widgets")
