...
def get_diff_net(cfg):
    ...
    checkpoint = torch.load(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "models", "dreamtalk", "checkpoints", "denoising_network.pth"))
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        # get renderer
        renderer = get_netG(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "models", "dreamtalk", "checkpoints", "renderer.pt"))
        # render video
