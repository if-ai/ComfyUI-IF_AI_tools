...
function makeModal(title, text, type = "info") {
  ...
  boxModal.className = "if_ai_tools_modal_window";
  const boxModalHtml = `
    <div class="if_ai_tools_modal_header" style="display: flex;  align-items: center;  background: #222;  width: 100%;justify-content: center;">
      <div class="if_ai_tools_modal_title" style="flex-basis: 85%; text-align: center;padding: 8px;">${title}</div>
      <div class="if_ai_tools_modal_close">✕</div>
    </div>
    <div class="if_ai_tools_modal_description" style="padding: 10px;">${text}</div>`;
  boxModal.innerHTML = boxModalHtml;

  const if_ai_tools_modal_header = boxModal.querySelector(".if_ai_tools_modal_header");
  Object.assign(if_ai_tools_modal_header.style, {
    display: "flex",
    alignItems: "center",
  });

  const close = boxModal.querySelector(".if_ai_tools_modal_close");
  ...
  showHide(overlay)
    ...
    .then(() =>
      boxModal
        .querySelector(".if_ai_tools_modal_close")
